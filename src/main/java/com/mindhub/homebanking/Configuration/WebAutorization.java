...
public class WebAutorization extends WebSecurityConfigurerAdapter {
     ...
     protected void configure(HttpSecurity http) throws Exception {
         ...
         http.authorizeRequests()
                 ...
                 .antMatchers("/web/assets/**", "/web/scripts/index.js","/styles/**").permitAll()
                 ...
                 .antMatchers(HttpMethod.POST, "/api/loans/types").hasAuthority( "ADMIN")

                 .antMatchers(HttpMethod.POST, "/api/clients/current/accounts").hasAnyAuthority("CLIENT", "ADMIN")

                 .antMatchers(HttpMethod.PATCH, "/api/clients/currents/accounts").hasAnyAuthority("CLIENT", "ADMIN")
                 ...
                 .antMatchers(HttpMethod.POST,"/api/post_net").hasAnyAuthority("CLIENT", "ADMIN")

                 .antMatchers("/web/**", "/api/clients/current").hasAnyAuthority("CLIENT", "ADMIN")

                 .antMatchers("/rest/**", "/h2-console/**","/api/**","/admin.html").hasAuthority("ADMIN");
